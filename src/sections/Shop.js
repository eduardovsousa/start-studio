  ...
  return (
    <Section ref={ref} id="shop">
      ...
      <Right data-scroll ref={Horizontalref}>
        <Product img={img3} title="Moletons" />
        <Product img={img4} title="Desgaste étnico" />
        <Product img={img1} title="Básico Masculino" />
        <Product img={img2} title="Tops" />
        <Product img={img5} title="Blazers" />
        <Product img={img6} title="Ternos" />
        <Product img={img7} title="Retrô" />
        <Product img={img8} title="Jóias" />
        <Product img={img9} title="Relógios" />
        <Product img={img10} title="Edição Especial" />
      </Right>
    </Section>
  );
};
